; stole the mikeos bootloader because i couldn't be fucked to write one myself
...
OEMLabel		db "BISMUTH "	; Disk label
...
VolumeLabel		db "BISMUTH    "; Volume Label: any 11 chars
